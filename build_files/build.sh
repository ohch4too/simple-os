...
flatpak remote-add --if-not-exists --authenticator-name=org.flatpak.Authenticator.Oci --system fedora oci+https://registry.fedoraproject.org
...
#flatpak --system --noninteractive --no-deps -y install flathub org.gnome.Calculator org.gnome.TextEditor org.gnome.Loupe org.gnome.Snapshot org.gnome.Evince org.virt_manager.virt-manager org.mozilla.firefox org.chromium.Chromium
